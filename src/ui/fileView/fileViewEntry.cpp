...
FileViewEntry::FileViewEntry(int page, const irect &position,
                             const FileItem &entry)
    : ListViewEntry(page, position), _entry(entry) {}

void FileViewEntry::draw(const ifont *entryFont, const ifont *entryFontBold,
                         int fontHeight) {
